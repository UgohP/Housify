"""
Django settings for housify project.
...
SECRET_KEY = 'django-insecure-3!wxk^*!k0lwk-j1*54ez_h8j4&@yqt*v=(e4x#&#qx14d#(+s'
...
WSGI_APPLICATION = 'housify.wsgi.application'
